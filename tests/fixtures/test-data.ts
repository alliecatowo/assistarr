...
export const mockRadarrMovies = [
  {
    ...
    remotePoster:
      "https://image.tmdb.org/t/p/original/9gk7adHYeDvHkCSEqAvQNLV5Ber.jpg",
    images: [
      {
        coverType: "poster",
        remoteUrl:
...
export const mockJellyfinContinueWatching = [
  {
    ...
    Type: "Movie",
    UserData: {
      PlaybackPositionTicks: 44_400_000_000,
      PlayedPercentage: 50,
    },
  },
];
...
export const mockQBittorrentTransferInfo = {
  dl_info_speed: 15_728_640,
  dl_info_data: 107_374_182_400,
  up_info_speed: 1_572_864,
